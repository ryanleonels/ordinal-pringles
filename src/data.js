...
function getDefaultObject() {
    return {
        ...
        incrementy: {amt:D(0), hasIUP:Array(12).fill(false), rebuyableAmt: Array(6).fill(0), charge:0, totalCharge:0, bestAmt:D(0)},
...
function fixOldSaves(){
    ...
    //v0.0.6 => v0.1+
    if(data.collapse.times === 0 && data.ord.ordinal.gt(BHO_VALUE) && data.ord.isPsi && data.ord.base === 3) data.ord.ordinal = D(BHO_VALUE)
    //v0.0.5 => v0.0.6+
