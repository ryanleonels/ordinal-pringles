...
let cupData = [
    ...
    {text: "Ordinal Powers boost AutoBuyers and AutoClickers", cost: 243, effect: ()=> Decimal.min((D(data.markup.powers).gt(4e256) ? Decimal.log10(data.markup.powers) : Decimal.pow(data.markup.powers, 1/256)), Number.MAX_VALUE)},
